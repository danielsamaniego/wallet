...
import type { ICreateWalletUseCase } from "../../../../../application/ports/inbound/create-wallet.usecase.js";
...
export function createWalletRoute(handler: ICreateWalletUseCase) {
