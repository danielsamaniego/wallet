...
// "owner" is intentionally excluded: grouping by owner is meaningless for a
// single wallet (that's the platform-wide endpoint's job).
const GroupBySchema = z.enum(["type", "day", "week", "month", "metadata"]);
